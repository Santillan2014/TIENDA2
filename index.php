...
<div class="full-width-slider">
<div class="item full-width-slider" style="background-image: url(sets/images/sliders/slider2.png);">
</div>
</div>
</div>
</div>
...
<h6 class="text">envio gratis en pedidos mayores a $.600.00</h6></div>
</div>
<div class="col-md-6 col-sm-4 col-lg-4">
<div class="info-box">
<div class="row">
